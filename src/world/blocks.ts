...
BLOCKS[B.STONE] = def('pedra', 0x8f9394, 0x87898b, 0x7e8082, { drops: B.COBBLE });
...
BLOCKS[B.WATER] = def('água', 0x3f76c9, 0x3a6fc0, 0x3564ad, { solid: false, opaque: false });
...
BLOCKS[B.STONE_BRICK] = def('tijolo de pedra', 0x9aa0a3, 0x8e9497, 0x82888b, { structural: true, drops: B.STONE_BRICK });
...
BLOCKS[B.IRON_BLOCK] = def('bloco de ferro', 0xf1f5f9, 0xe2e8f0, 0xcbd5e1, { structural: true, drops: B.IRON_BLOCK });
BLOCKS[B.GOLD_BLOCK] = def('bloco de ouro', 0xfde047, 0xeab308, 0xca8a04, { structural: true, drops: B.GOLD_BLOCK });
BLOCKS[B.DIAMOND_BLOCK] = def('bloco de diamante', 0x38bdf8, 0x0284c7, 0x0369a1, { structural: true, drops: B.DIAMOND_BLOCK });
BLOCKS[B.GLOWSTONE] = def('pedra luminosa', 0xfef08a, 0xfde047, 0xeab308, { structural: true, drops: B.GLOWSTONE });
BLOCKS[B.OBSIDIAN] = def('obsidiana', 0x1e1b4b, 0x18181b, 0x09090b, { structural: true, drops: B.OBSIDIAN });
BLOCKS[B.BRICK] = def('tijolo', 0xb91c1c, 0x991b1b, 0x7f1d1d, { structural: true, drops: B.BRICK });
BLOCKS[B.DARK_STONE] = def('pedra escura', 0x334155, 0x1e293b, 0x0f172a, { structural: true, drops: B.DARK_STONE });
...
export function isReplaceable(t: number): boolean {
  return t === B.AIR || t === B.WATER || isDecor(t);
}
